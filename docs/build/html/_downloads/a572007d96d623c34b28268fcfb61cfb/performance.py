...
def performance_scale_factor(file_path, interpolation_methods):
    ...
    scale_factor_list = [0.1, 0.2, 0.3, 0.5]
    n = 1
    ...
    plt.legend()
    plt.savefig(
        "/home/andrey_kirkicha/Study/Python_IITP_RAS/plots/performance_scale_factor.jpg"
    )


if __name__ == "__main__":
    file_path = "/home/andrey_kirkicha/Study/Python_IITP_RAS/example/example.jpg"
